...
public class EmployeeNumberTests : TestBase
{
    ...
    public void Constructor_FromStartDateAndSequence_ShouldInitializeProperly()
    {
        ...
        var sequence = Random.NextPositive();
    ...
    public void Constructor_FromStartDateAndSequence_InvalidSequence_ShouldThrowContractException()
    {
        //Arrange
        var startDate = Random.NextDateTimeInFuture();
        var invalidSequence = Random.NextZeroOrNegative();
    ...
    {
        new object[] { new DateTime(2000, 12, 29), 987, "20001229987" }, new object[] { new DateTime(1, 2, 3), 4, "00010203004" } //with padded zero's
    };
}