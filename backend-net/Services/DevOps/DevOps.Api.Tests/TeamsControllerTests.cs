...
public class TeamsControllerTests : TestBase
{
    ...
    {
        //Arrange
        var allTeams = new List<Team>() { new TeamBuilder().Build(), new TeamBuilder().Build() };
    ...
    public void AssembleTeam_TeamExists_ShouldUseService()
    {
        ...
        var inputModel = new TeamAssembleInputModel { RequiredNumberOfDevelopers = Random.Next(2, 11) };
