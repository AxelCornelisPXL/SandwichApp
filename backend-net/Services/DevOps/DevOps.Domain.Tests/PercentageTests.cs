...
public class PercentageTests : TestBase
{
    ...
    public void ImplicitConvertFromDouble_ShouldCorrectlyConvert()
    {
        ...
        var samePercentage = new Percentage(value);
        Assert.That(percentage, Is.EqualTo(samePercentage));
    }

    private static object[] _toStringCases = { new object[] { 0.5, "50%" }, new object[] { 1.0, "100%" }, new object[] { 0.40123, "40,12%" }, new object[] { 0.21987, "21,99%" }, new object[] { 0.005, "0,5%" } };
}