...
internal class DevOpsDbInitializer
{
    ...
    public void SeedData()
    {
        ...
        _context.Teams.AddRange(new[] { Team.CreateNew("Alpha"), Team.CreateNew("Beta") });

        _context.Developers.AddRange(new[] { Developer.CreateNew("20210920001", "Kris", "Hermans", 0.5), Developer.CreateNew("20210920002", "Wesley", "Hendrikx", 0.5) });
